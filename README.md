...
Whenever props change, we will set the state inside useEffect.In this way, whenever props get changed, it will set as the state inside useEffect. useEffect is primarily to handle side effects.